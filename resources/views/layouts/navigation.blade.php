    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @admin
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pastQuestions.create')" :active="request()->routeIs('pastQuestions.create')">
                        {{ __('Create PastQuestion') }}
                    </x-nav-link>
                </div>
                @endadmin
                @admin
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('pastQuestions.all')" :active="request()->routeIs('pastQuestions.all')">
                        {{ __('All PastQuestions') }}
                    </x-nav-link>
                </div>
                @endadmin
            </div>
